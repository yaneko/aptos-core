...
use crate::protocols::wire::messaging::v1::{
    metadata::{MessageType, MultiplexMessageWithMetadata, NetworkMessageWithMetadata},
...
impl OutboundStream {
    ...
    pub async fn stream_message(
        ...
        header_message_metadata.update_message_type(MessageType::StreamedMessageHead);
        ...
        for (index, chunk) in chunks.enumerate() {
            ...
            let message_type = if index == num_chunks - 1 {
                MessageType::StreamedMessageTail
            } else {
                MessageType::StreamedMessageFragment
            };
            fragment_message_metadata.update_message_type(message_type);

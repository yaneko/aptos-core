...
use aptos_types::{aggregate_signature::AggregateSignature, PeerId, transaction::ReplayProtector};
use maplit::hashset;
...
fn test_proof_calculate_remaining_txns_and_proofs() {
    ...
    let author_1 = PeerId::random();
    let txns = vec![
        TxnSummaryWithExpiration::new(PeerId::ONE, ReplayProtector::SequenceNumber(0), now_in_secs + 1, HashValue::zero()),
        TxnSummaryWithExpiration::new(PeerId::ONE, ReplayProtector::SequenceNumber(1), now_in_secs + 1, HashValue::zero()),
        TxnSummaryWithExpiration::new(PeerId::ONE, ReplayProtector::SequenceNumber(2), now_in_secs + 1, HashValue::zero()),
        TxnSummaryWithExpiration::new(PeerId::ONE, ReplayProtector::SequenceNumber(3), now_in_secs + 1, HashValue::zero()),
    ];
...
fn test_proof_pull_proofs_with_duplicates() {
    ...
    let txns = vec![
        TxnSummaryWithExpiration::new(PeerId::ONE, ReplayProtector::SequenceNumber(0), now_in_secs + 2, HashValue::zero()),
        TxnSummaryWithExpiration::new(PeerId::ONE, ReplayProtector::SequenceNumber(1), now_in_secs + 1, HashValue::zero()),
        TxnSummaryWithExpiration::new(PeerId::ONE, ReplayProtector::SequenceNumber(2), now_in_secs + 3, HashValue::zero()),
        TxnSummaryWithExpiration::new(PeerId::ONE, ReplayProtector::SequenceNumber(3), now_in_secs + 4, HashValue::zero()),
    ];

...
pub mod live_data_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn ping(
            &mut self,
            request: impl tonic::IntoRequest<super::PingLiveDataServiceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::PingLiveDataServiceResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aptos.indexer.v1.LiveDataService/Ping",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aptos.indexer.v1.LiveDataService", "Ping"));
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn get_transactions(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aptos.indexer.v1.LiveDataService/GetTransactions",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "aptos.indexer.v1.LiveDataService",
                        "GetTransactions",
                    ),
                );
            self.inner.server_streaming(req, path, codec).await
...
pub mod live_data_service_server {
    ...
    pub trait LiveDataService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn ping(
            &self,
            request: tonic::Request<super::PingLiveDataServiceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::PingLiveDataServiceResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/aptos.indexer.v1.LiveDataService/Ping" => {
                    #[allow(non_camel_case_types)]
                    struct PingSvc<T: LiveDataService>(pub Arc<T>);
                    impl<
                        T: LiveDataService,
                    > tonic::server::UnaryService<super::PingLiveDataServiceRequest>
                    for PingSvc<T> {
                        type Response = super::PingLiveDataServiceResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LiveDataService>::ping(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/aptos.indexer.v1.LiveDataService/GetTransactions" => {
                    #[allow(non_camel_case_types)]
                    struct GetTransactionsSvc<T: LiveDataService>(pub Arc<T>);
                    impl<
                        T: LiveDataService,
                    > tonic::server::ServerStreamingService<
                        super::GetTransactionsRequest,
                    > for GetTransactionsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LiveDataService>::get_transactions(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aptos.indexer.v1.LiveDataService";
    impl<T> tonic::server::NamedService for LiveDataServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
pub mod historical_data_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    ///
    #[derive(Debug, Clone)]
    pub struct HistoricalDataServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl HistoricalDataServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> HistoricalDataServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::BoxBody>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> HistoricalDataServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            HistoricalDataServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        pub async fn ping(
            &mut self,
            request: impl tonic::IntoRequest<super::PingHistoricalDataServiceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::PingHistoricalDataServiceResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aptos.indexer.v1.HistoricalDataService/Ping",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("aptos.indexer.v1.HistoricalDataService", "Ping"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aptos.indexer.v1.HistoricalDataService/GetTransactions",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "aptos.indexer.v1.HistoricalDataService",
                        "GetTransactions",
                    ),
                );
            self.inner.server_streaming(req, path, codec).await
...
/// Generated server implementations.
pub mod historical_data_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with HistoricalDataServiceServer.
    #[async_trait]
    pub trait HistoricalDataService: std::marker::Send + std::marker::Sync + 'static {
        ///
        async fn ping(
            &self,
            request: tonic::Request<super::PingHistoricalDataServiceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::PingHistoricalDataServiceResponse>,
            tonic::Status,
        >;
    ...
    ///
    #[derive(Debug)]
    pub struct HistoricalDataServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> HistoricalDataServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    for HistoricalDataServiceServer<T>
    where
        T: HistoricalDataService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        type Response = http::Response<tonic::body::BoxBody>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/aptos.indexer.v1.HistoricalDataService/Ping" => {
                    #[allow(non_camel_case_types)]
                    struct PingSvc<T: HistoricalDataService>(pub Arc<T>);
                    impl<
                        T: HistoricalDataService,
                    > tonic::server::UnaryService<
                        super::PingHistoricalDataServiceRequest,
                    > for PingSvc<T> {
                        type Response = super::PingHistoricalDataServiceResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as HistoricalDataService>::ping(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/aptos.indexer.v1.HistoricalDataService/GetTransactions" => {
                    #[allow(non_camel_case_types)]
                    struct GetTransactionsSvc<T: HistoricalDataService>(pub Arc<T>);
                    impl<
                        T: HistoricalDataService,
                    > tonic::server::ServerStreamingService<
                        super::GetTransactionsRequest,
                    > for GetTransactionsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as HistoricalDataService>::get_transactions(
                                        &inner,
                                        request,
                                    )
                                    .await
    ...
    impl<T> Clone for HistoricalDataServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aptos.indexer.v1.HistoricalDataService";
    impl<T> tonic::server::NamedService for HistoricalDataServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
